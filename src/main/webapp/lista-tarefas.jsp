...
<div class="wrapper d-flex align-items-stretch">
  ...
  <!--Tirulo da tarefa--> 
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    <li class="breadcrumb-item active" aria-current="page"> <span class="fa fa-file-o mr-3"></span>Minhas Tarefas</li>
		  </ol>
		</nav>
	...
	List<Tarefa> tarefa = dao.getTarefa();
  	...
  	%>
		...
		<tr>
			...
			<td><%= t.getData_termino() %></td>
			<td> <a href="removeTarefa?id=<%= t.getId()%>"> <span class="fa fa-trash-o mr-3"></span></a>  <a href="AlterarTarefa2.jsp?id=<%= t.getId()%>"><span class="fa fa-pencil-square-o mr-3"></span> </a>	</td>
